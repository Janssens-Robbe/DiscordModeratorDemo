...
internal class ChatCompletionResponse
{
    ...
    public class ChatCompletionResponseMessage
    {
        ...
        public ChatCompletionResponseToolCall[]? ToolCalls { get; init; }
    }

    public class ChatCompletionResponseToolCall
    {
        public required string Id { get; init; }
        public required string Type { get; init; }
        public required ChatCompletionResponseFunction Function { get; init; }
    }
